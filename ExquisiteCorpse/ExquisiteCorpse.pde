...
rect (0,0,width*.05*size,height*0.05*size); 
popMatrix(); 
  ...
  // ellipse 3 
  ellipse(width/2.5, y_kersh, 75, 75); 
  
 //ellipse 4 
  ellipse(width/2.2, y_kersh, 55, 55); 
   //ellipse 5 
  ellipse(width/2.7, y_kersh, 50, 50); 
 // ellipse 6
  ellipse(x_kersh,height/2.5,30,30);
  // ellipse 7
  ellipse(x_kersh,height/3,30,30);
   // ellipse 
  ellipse(x_kersh,height/4,30,30);
